...
const translations = {
  en: {
    ...
    profileText: "Reliable and hard-working candidate looking for an entry-level role in Ireland — open to hands-on work such as hospitality, retail, warehouse, cleaning, or general labour. Punctual, quick to learn, and comfortable with physical work. Able to work independently or as part of a team, and available to start immediately with flexible hours.",
  ...
  ua: {
    ...
    profileText: "Надійний і працьовитий кандидат, який шукає роботу початкового рівня в Ірландії — відкритий до практичної роботи в таких сферах, як обслуговування, роздрібна торгівля, склад, прибирання чи загальна фізична праця. Пунктуальний, швидко навчаюся й готовий до фізичної роботи. Можу працювати самостійно або в команді. Готовий розпочати роботу негайно та маю гнучкий графік.",
