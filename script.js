...
const translations = {
  en: {
    ...
    skill6: "Basic to intermediate computer skills — completed a QQI Level 5 course in programming",
  ...
  ua: {
    ...
    skill6: "Базові та середні комп'ютерні навички — завершив курс програмування QQI Level 5",
